...
<div class="container"  >
    <div class="row">
        ...
        <div class="col-sm-8" ng-controller="MainController" >
                ...
                <table class="table-striped">
                    ...
                    <tr class="table-header">
                        ...
                        <td class="my-table-cell3">
                            <form ng-show="permission.edit=='true'" action="${pageContext.request.contextPath}/departments/departmentForm.html"
                                  method="get">
                    ...
                    <c:forEach var="dep" items="${department}">
                        ...
                        <tr class="my-table-cell">
                            ...
                            <td class="my-table-cell3">
                                <form ng-show="permission.delete=='true'"  action="${pageContext.request.contextPath}/departments/delete.html" method="post">
                            ...
                            <td class="my-table-cell3">
                                <form ng-show="permission.edit=='true'" action="${pageContext.request.contextPath}/departments/edit.html" method="get">
                                    <input type="hidden" name="id" value="${dep.id}"/>
                                    <button type="submit" class="btn btn-default btn-lg">
